      ...
      >
        ...
        >
          <div className={cn('flex min-w-0 items-center', LOGO_COLUMN)}>
            <Link href="/" className="block w-full max-w-[min(100%,240px)]">
              <Media
                ...
                imgClassName={cn(
                  'w-auto max-w-full object-contain object-left transition-opacity duration-300 ease-out motion-reduce:transition-none',
